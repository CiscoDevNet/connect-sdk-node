import {WhatsappStickerMessage, WhatsappContentType} from "../../src";
import {expect} from "chai";

describe("WhatsappStickerMessage", () => {
    it("sets constructor values properly", () => {
        const message = new WhatsappStickerMessage('12345', '+14443332222', 'http://www.site.com/sticker.png', 'image/png');
    ...
    it("throws validation errors correctly", () => {
        ...
        expect(message.contentType).to.equal(WhatsappContentType.STICKER);
