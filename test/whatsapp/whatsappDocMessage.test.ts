import {WhatsappDocMessage, WhatsappContentType} from "../../src";
import {expect} from "chai";

describe("WhatsappDocMessage", () => {
    ...
    it("throws validation errors correctly", () => {
        ...
        expect(message.contentType).to.equal(WhatsappContentType.DOCUMENT);
