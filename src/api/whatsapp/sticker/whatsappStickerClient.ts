...
import {WhatsappStickerMessage} from "./whatsappStickerMessage";

export class WhatsappStickerClient extends CpaasClient {
    sendMessage(message: WhatsappStickerMessage) {
