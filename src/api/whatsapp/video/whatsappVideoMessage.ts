...
/**
 * Message class to construct a video object to send to a WhatsappClient
 */

export class WhatsappVideoMessage {
    /**
     * @remark Identifies to Whatsapp that this is an video message
     */
    private _contentType: string = WhatsappContentType.VIDEO;
    /**
